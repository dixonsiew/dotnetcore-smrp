...
using smrp.Controllers.Report.MasterPD105;
using smrp.Dtos;
using smrp.Models;
using smrp.Services;
using smrp.sql;
...
namespace smrp.Controllers.Report
{
    ...
    public class MasterPD105Controller : ControllerBase
    {
        ...
        public MasterPD105Controller(DefaultConnection conn, RsConnection rsconn, IConfiguration cfg, IMongoClient cli, ILogger<MasterPD105Controller> logger)
        {
            rscon = rsconn;
            config = cfg;
            client = cli;
