...
namespace smrp.Controllers.Setup
{
    ...
    [ApiController]
    [Authorize]
    public class PersonCategoryCodeController : ControllerBase
    {
        private readonly CommonSetupService commonSetupService;
        private const string table = "person_category_code";

        public PersonCategoryCodeController(DefaultConnection conn)
        {
        ...
        [HttpPost("person-category-codes")]
        ...
        [HttpGet("person-category-code/{id}")]
        ...
        [HttpPut("person-category-code/{id}")]
        ...
        [HttpDelete("person-category-code/{id}")]
