namespace smrp.sql
{
    public class Sql
    {
        public static string GetMasterPD101(string visitType)
        {
            var s = @$"
            SELECT
        ...
        public static string GetMasterPD301(string visitType)
        {
            var s = $@"
            SELECT
                NV.ACCOUNT_NO,
        ...
        public static string GetMasterPD102()
        {
            var s = @"
            SELECT
                NV.ACCOUNT_NO,
        ...
        public static string GetMasterPD105()
        {
            var s = @"
            SELECT 
                DISTINCT PAT.PRN,
